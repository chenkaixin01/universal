package com.chenkx.universal.generator.action.config;
...
import com.chenkx.universal.generator.engine.SimpleTemplateEngine;
import com.chenkx.universal.generator.engine.base.UniversalTemplateEngine;
import com.chenkx.universal.generator.engine.config.ContextConfig;
import com.chenkx.universal.generator.engine.config.SqlConfig;
import com.chenkx.universal.core.util.FileUtil;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doUniversalGeneration() {
        UniversalTemplateEngine UniversalTemplateEngine = new SimpleTemplateEngine();
        UniversalTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        UniversalTemplateEngine.setSqlConfig(sqlConfig);
        UniversalTemplateEngine.setTableInfo(tableInfo);
        UniversalTemplateEngine.start();
    }
}
