...
public class ContextConfig {
    ...
    private String templatePrefixPath = "universalTemplate/advanced";
    private String projectPath = "E:\\universal";//模板输出的项目目录
    ...
    private String proPackage = "com.chenkx.universal.admin";
    private String coreBasePackage = "com.chenkx.universal.core";
    private String modelPackageName = "com.chenkx.universal.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.chenkx.universal.admin.common.persistence.dao";  //model的dao
    private String schedulerJobPackageName = "com.chenkx.universal.admin.modular.job.jobClass";
    ...
    public String getSchedulerJobPackageName() {
        return schedulerJobPackageName;
    }

    public void setSchedulerJobPackageName(String schedulerJobPackageName) {
        this.schedulerJobPackageName = schedulerJobPackageName;
    }
