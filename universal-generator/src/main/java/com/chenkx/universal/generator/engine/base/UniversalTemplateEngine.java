package com.chenkx.universal.generator.engine.base;
 ...
 */
public abstract class UniversalTemplateEngine extends AbstractTemplateEngine {

    private GroupTemplate groupTemplate;

    public UniversalTemplateEngine() {
        initBeetlEngine();
    }
    ...
    protected void configTemplate(Template template) {
        ...
        template.binding("job",super.jobConfig);
    ...
    public void start() {
        ...
        if(super.contextConfig.getJobSwitch()){
            generateJobs();
        }
    }

    protected abstract void generateJobs();
