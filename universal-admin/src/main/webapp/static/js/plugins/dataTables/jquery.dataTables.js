...
(/** @lends <global> */function( $ ) {
	 ...
	 *
	 * @param {object} oSettings dataTables settings object
	 * @param {array} data Data to send to the client, required by
	...
	/**
	 * Build up the parameters in an object needed for a client-side processing
	...
	/**
	 * Data the data from the client (nuking the old) and redraw the table
	 *  @param {object} oSettings dataTables settings object
	 *  @param {object} json json data return from the client.
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @param  {object} json Data source object / array from the client
	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
		...
		/* In client-side processing all filtering is done by the client, so no point hanging around here */
	 ...
	 * Draw the table for the first time, adding all required features
	 *  @param {object} oSettings dataTables settings object
	 *  @param {object} [json] JSON from the client that completed the table, if using Ajax source
	...
	function _fnSort ( oSettings )
	{
		...
		/* No sorting required if client-side or no sorting array */
	...
	function _fnSortAttachListener ( settings, attachTo, colIdx, callback )
	{
		...
		_fnBindAction( attachTo, {}, function (e) {
			...
			setTimeout( function() {
				...
				// In client-side processing, the draw callback will remove the
				// processing display
	...
	DataTable = function( options )
	{
		 ...
		 * client-side processing (i.e. "bServerSide": true), then to add data, you
		 * must add it to the data source, i.e. the client-side, through an Ajax call.
	 ...
	 * client. Note that this returns the JSON from the first table in the current
	 * context.
	 *
	 * @return {object} JSON received from the client.
	 */
	...
	DataTable.defaults = {
		 ...
		 *   to the client. The function takes a single parameter, an object of
		 ...
		 *   from an Ajax source or for client-side processing - this parameter
		 *   allows that property to be changed. You can use Javascript dotted
		 *   object notation to get a data source for multiple levels of nesting, or
		 *   it my be used as a function. As a function it takes a single parameter,
		 *   the JSON returned from the client, which can be manipulated as
		 *   required, with the returned value being that used by DataTables as the
		 *   data source for the table. This supersedes `sAjaxDataProp` from
		 *   DataTables 1.9-.
		 *
		 * * `success` - Should not be overridden it is used internally in
		 *   DataTables. To manipulate / transform the data returned by the client
		 ...
		 * parameters are:
		 *
		 * 1. _object_ - Data to send to the client
		 ...
		 *
		 * @example
		 *   // Manipulate the data returned from the client - add a link to data
		...
		/**
		 * Configure DataTables to use client-side processing. Note that the
		 ...
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 *  @param {object} json The JSON object request from the client - only
		 ...
		 * the data from the client so something more suitable for your application.
		 ...
		 * superseded by that provided through `ajax`, which should be used instead.
		 *
		 *  It is often useful to send extra data to the client when making an Ajax
		 * request - for example custom filtering information, and this callback
		 * function makes it trivial to send extra information to the client. The
		 * passed in parameter is the data set that has been constructed by
		 * DataTables, and you can add to this or modify it as you require.
		 *  @type function
		 *  @param {array} data Data array (array of objects which are name/value
		 *    pairs) that has been constructed by DataTables and will be sent to the
		 *    client. In the case of Ajax sourced data with client-side processing
		 *    this will be an empty array, for client-side processing there will be a
		 ...
		 * but you might wish to use a client-side database or cookies.
		 *  @type function
		 *  @member
		 *  @param {object} settings DataTables settings object
		 ...
		 *          var o;
		 *
		 *          // Send an Ajax request to the client to get the data. Note that
		 ...
		 *          // Send an Ajax request to the client with the state object
		 *          $.ajax( {
		 *            "url": "/state_save",
		 *            "data": data,
		 *            "dataType": "json",
		...
		/**
		 * When enabled DataTables will not make a request to the client for the first
		...
		"oLanguage": {
			 ...
			 * parameter is not used when loading data by client-side processing, just
			 ...
			 * client-side, which DataTables will look up if this parameter is passed.
		 ...
		 * source or for client-side processing - this parameter allows that
		 ...
		 * superseded by that provided through `ajax`, which should be used instead.
		 *
		 * Set the HTTP method that is used to make the Ajax call for client-side
	...
	DataTable.defaults.column = {
		...
		/**
		 * This parameter is only used in DataTables' client-side processing. It can
		 * be exceptionally useful to know what columns are being displayed on the
		 * client side, and to map these to database fields. When defined, the names
		 * also allow DataTables to reorder information from the client if it comes
		 * back in an unexpected order (i.e. if you switch your columns around on the
		 * client-side, your client-side code does not also need updating).
		 *  @type string
		 *  @default <i>Empty string</i>
		 *
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			 ...
			 * difference at all fro DOM and client-side processing tables.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
			 ...
			 * user request - typically an Ajax request for client-side processing.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
			 ...
			 * get all data from the client for every draw - there is no filtering,
		...
		/**
		 * Indicate if when using client-side processing the loading of data
		 ...
		 * can be an empty string (when not client-side processing), in which case
		...
		/**
		 * The last jQuery XHR object that was used for client-side data gathering.
		...
		/**
		 * JSON returned from the client in the last Ajax request
		 *  @type object
		 *  @default undefined
		 */
		"json": undefined,
		...
		/**
		 * Function to get the client-side data.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type function
		 */
		 ...
		 * parameters can easily be sent to the client
		 *  @type array
		 *  @default []
		 */
		"aoServerParams": [],
		 ...
		 * the client-side processing setting.
		 *  @type int
		 *  @default 0
		 *  @private
		 */
	...
	DataTable.ext = _ext = {
		...
		legacy: {
			/**
			 * Enable / disable DataTables 1.9 compatible client-side processing
			 * requests
			 *
			 *  @type boolean
			 *  @default false
	 ...
	 * request to made to the client for new data. This event is called before
	 * DataTables processed the returned data, so it can also be used to pre-
	 * process the data returned from the client, if needed.
	 *
	 ...
	 *  @param {event} e jQuery event object
	 *  @param {object} o DataTables settings object {@link DataTable.models.oSettings}
	 *  @param {object} json JSON returned from the client
	 *
	 *  @example
	 *     // Use a custom property returned from the client in another DOM element
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json) {
	 *       $('#status').html( json.status );
	 *     } );
	 *
	 *  @example
	 *     // Pre-process the data returned from the client
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json) {
