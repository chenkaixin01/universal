...
import com.chenkx.universal.common.constant.dictmap.UserDict;
import com.chenkx.universal.common.constant.factory.ConstantFactory;
import com.chenkx.universal.common.constant.state.ManagerStatus;
...
import com.chenkx.universal.core.base.tips.Tip;
import com.chenkx.universal.core.datascope.DataScope;
import com.chenkx.universal.core.db.Db;
import com.chenkx.universal.core.exception.UniversalException;
import com.chenkx.universal.core.log.LogObjectHolder;
import com.chenkx.universal.core.shiro.ShiroKit;
import com.chenkx.universal.core.shiro.ShiroUser;
import com.chenkx.universal.core.util.ToolUtil;
import com.chenkx.universal.modular.system.dao.UserMgrDao;
import com.chenkx.universal.modular.system.factory.UserFactory;
import com.chenkx.universal.modular.system.transfer.UserDto;
import com.chenkx.universal.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Resource
    private UniversalProperties universalProperties;
    ...
    public String roleAssign(@PathVariable Integer userId, Model model) {
        if (ToolUtil.isEmpty(userId)) {
            throw new UniversalException(BizExceptionEnum.REQUEST_NULL);
        }
    ...
    public Object changePwd(@RequestParam String oldPwd, @RequestParam String newPwd, @RequestParam String rePwd) {
        if (!newPwd.equals(rePwd)) {
            throw new UniversalException(BizExceptionEnum.TWO_PWD_NOT_MATCH);
        }
        Integer userId = ShiroKit.getUser().getId();
        ...
        if (user.getPassword().equals(oldMd5)) {
            ...
            throw new UniversalException(BizExceptionEnum.OLD_PWD_NOT_RIGHT);
        }
    }
    ...
    public Tip add(@Valid UserDto user, BindingResult result) {
        ...
        if (theUser != null) {
            throw new UniversalException(BizExceptionEnum.USER_ALREADY_REG);
        }
    ...
    public Tip edit(@Valid UserDto user, BindingResult result) throws NoPermissionException {
        ...
        if (ShiroKit.hasRole(Const.ADMIN_NAME)) {
            ...
            if (shiroUser.getId().equals(user.getId())) {
                ...
                throw new UniversalException(BizExceptionEnum.NO_PERMITION);
            }
        }
    }
    ...
    public Tip delete(@RequestParam Integer userId) {
        ...
        if (userId.equals(Const.ADMIN_ID)) {
            throw new UniversalException(BizExceptionEnum.CANT_DELETE_ADMIN);
        }
        assertAuth(userId);
    ...
    public Tip freeze(@RequestParam Integer userId) {
        ...
        //不能冻结超级管理员
        if (userId.equals(Const.ADMIN_ID)) {
            throw new UniversalException(BizExceptionEnum.CANT_FREEZE_ADMIN);
        }
        assertAuth(userId);
    ...
    public Tip setRole(@RequestParam("userId") Integer userId, @RequestParam("roleIds") String roleIds) {
        ...
        //不能修改超级管理员
        if (userId.equals(Const.ADMIN_ID)) {
            throw new UniversalException(BizExceptionEnum.CANT_CHANGE_ADMIN);
        }
        assertAuth(userId);
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = universalProperties.getFileUploadPath();
            picture.transferTo(new File(fileSavePath + pictureName));
        } catch (Exception e) {
            throw new UniversalException(BizExceptionEnum.UPLOAD_ERROR);
        }
        return pictureName;
    }
