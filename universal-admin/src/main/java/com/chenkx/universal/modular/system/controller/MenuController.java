...
import com.chenkx.universal.common.constant.dictmap.MenuDict;
import com.chenkx.universal.common.constant.factory.ConstantFactory;
import com.chenkx.universal.common.constant.state.MenuStatus;
import com.chenkx.universal.common.exception.BizExceptionEnum;
import com.chenkx.universal.common.persistence.dao.MenuMapper;
import com.chenkx.universal.common.persistence.model.Menu;
...
import com.chenkx.universal.core.node.ZTreeNode;
import com.chenkx.universal.core.support.BeanKit;
import com.chenkx.universal.core.util.ToolUtil;
import com.chenkx.universal.modular.system.dao.MenuDao;
import com.chenkx.universal.modular.system.service.IMenuService;
import com.chenkx.universal.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new UniversalException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new UniversalException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
