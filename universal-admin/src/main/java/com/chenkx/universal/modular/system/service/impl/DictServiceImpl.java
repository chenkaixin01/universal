...
import com.chenkx.universal.common.persistence.dao.DictMapper;
import com.chenkx.universal.common.persistence.model.Dict;
import com.chenkx.universal.core.exception.UniversalException;
import com.chenkx.universal.modular.system.dao.DictDao;
import com.chenkx.universal.modular.system.service.IDictService;
...
import static com.chenkx.universal.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if(dicts != null && dicts.size() > 0){
            throw new UniversalException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new UniversalException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
