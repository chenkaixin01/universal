package com.chenkx.universal.modular.code.factory;


import com.chenkx.universal.UniversalApplication;
import com.chenkx.universal.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("chenkx");
        genQo.setProjectPackage(UniversalApplication.class.getPackage().getName());
