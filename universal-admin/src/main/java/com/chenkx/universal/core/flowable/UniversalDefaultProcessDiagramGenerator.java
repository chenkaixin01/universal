...
package com.chenkx.universal.core.flowable;
 ...
 */
public class UniversalDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public UniversalDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public UniversalDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
